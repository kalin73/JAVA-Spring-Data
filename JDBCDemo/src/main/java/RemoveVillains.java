...
public class RemoveVillains {
	...
	private static final String GET_ALL_MINION_COUNT_BY_VILLAIN_ID = "SELECT COUNT(mv.minion_id) m_count FROM minions_villains mv WHERE mv.villain_id = ?";
	...
	private static final String DELETE_MINIONS_BY_VILLAIN_ID = "DELETE FROM minions_villains as mv WHERE mv.villain_id = ?";
	...
	private static final String COUNT_OF_DELETED_MINIONS_FORMAT = "%d minions released";
	...
	public static void main(String[] args) throws SQLException {
		...
		final PreparedStatement selectAllMinions = connection.prepareStatement(GET_ALL_MINION_COUNT_BY_VILLAIN_ID);
